  ...
  return (
    <AnimatedPage>
      <div className="flex w-full h-screen">
        <div className="hidden md:flex flex-col bg-gradient-to-b from-cyan-500 to-blue-600 w-1/2 h-full p-8">
        ...
        <div className="bg-white flex w-full md:w-1/2 h-full items-center justify-center">
          <LoginForm />
        </div>
      </div>
    </AnimatedPage>
